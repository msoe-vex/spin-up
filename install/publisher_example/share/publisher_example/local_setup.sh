...
: ${AMENT_CURRENT_PREFIX:="/workspaces/vscode-docker/install/publisher_example"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_example/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/publisher_example/environment/path.sh"
