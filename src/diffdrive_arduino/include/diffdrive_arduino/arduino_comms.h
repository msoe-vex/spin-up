...
class ArduinoComms : public rclcpp::Node {
 ...
 private:
  ...
  std::vector<std::string> l_topic_names_{
      "leftFrontTopMotor", "leftFrontBottomMotor", "leftRearTopMotor",
      "leftRearBottomMotor"};
  std::vector<std::string> r_topic_names_{
      "rightFrontTopMotor", "rightFrontBottomMotor", "rightRearTopMotor",
  ...
  std::vector<rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr>
      l_publishers_;
  std::vector<rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr>
      r_publishers_;
};
