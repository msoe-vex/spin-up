...
const int kProsMaxJoystickAnalog = 127;  // Max value of a controller stick
}  // namespace constant
...
#define ROTATION_ANGLE_THRESHOLD (M_PI / 3)
//Keeping this here because it was in the code but never used
...
#define DRIVE_TRACK_WIDTH 12.65 - 0.95

#define ODOM_PERPENDICULAR_X 0.019
#define ODOM_PERPENDICULAR_Y -3.862

#define ODOM_PARALLEL_X 0.692
#define ODOM_PARALLEL_Y 0.703
